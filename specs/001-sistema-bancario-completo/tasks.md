...
- [ ] T010 Persistencia JPA `customers-service`: `SpringDataClienteRepository`, `CustomerRepositoryJpa`, `BaseDatos.sql`
...
**Criterio de completitud**:
- `ConsultarClienteUseCaseTest` pasa 100% en verde sin contexto Spring.
